/*
	MODIFIED: gladLoadGLLoader gives negative error code


    OpenGL loader generated by glad 0.1.36 on Sun Apr 14 10:17:17 2024.
...
int gladLoadGLLoader(GLADloadproc load) {
	...
	if(GLVersion.major == 0 && GLVersion.minor == 0) return -4;
	return 1;
}
